...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", type=str, default="/home/zhaoxiang/dataset", help="path to dataset")
    parser.add_argument("--output-dir", type=str, default=f"{DIR}", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--config-file", type=str, default=f"configs/trainers/{TRAINER}/{CFG}.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
